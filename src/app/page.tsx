        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-secondary-600 via-secondary-700 to-secondary-800 text-white">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
            <div className="text-center">
              ...
              <h1 className="text-5xl md:text-7xl font-extrabold mb-6 animate-fade-in text-white">
                Réservez vos salles
                <br />
              ...
              <p className="text-xl md:text-2xl text-gray-100 mb-10 max-w-3xl mx-auto animate-fade-in leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in">
                {user ? (
                  <Link href="/rooms">
                    <Button size="lg" className="bg-white text-primary-600 hover:bg-gray-100 shadow-xl hover:shadow-2xl transition-all duration-300 group">
                  ...
                  <>
                    <Link href="/register">
                      <Button size="lg" className="bg-white text-primary-600 hover:bg-gray-100 shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                return (
                  ...
                  >
                    <div className={`w-14 h-14 ${feature.color} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-12 relative">
              {/* Connection lines */}
              <div className="hidden md:block absolute top-16 left-0 right-0 h-0.5 bg-primary-300"></div>
              ...
              {[
                ...
                <div key={i} className="relative text-center">
                  <div className="relative inline-flex items-center justify-center w-32 h-32 mb-6">
                    ...
                    <div className="relative bg-primary-600 rounded-full w-24 h-24 flex items-center justify-center shadow-xl">
        ...
        {!user && (
          <section className="py-24 bg-gradient-to-br from-primary-500 via-primary-600 to-secondary-600 text-white relative overflow-hidden">
            ...
            <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <Link href="/register">
                <Button size="lg" className="bg-white text-primary-600 hover:bg-gray-100 shadow-2xl hover:scale-105 transition-transform">
